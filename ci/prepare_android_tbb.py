...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--tbb-ref", default="")
...
def main() -> int:
    ...
    version_token = tbb_ref.lstrip("v")
    ...
    ensure_clone(source_dir, tbb_repo, tbb_ref)
    ...
    env_map = {
        "OV_ANDROID_TBB_REPO": tbb_repo,
        "OV_ANDROID_TBB_REF": tbb_ref,
